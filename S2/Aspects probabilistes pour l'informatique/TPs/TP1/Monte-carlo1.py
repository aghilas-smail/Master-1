...
Dans cette appliquette n est le nombre total de points générés par une suite pseudo-aléatoire, p est le nombre de points
à l'intérieur du quart de disque et 4 p / n donne par conséquent une valeur approchée de π
